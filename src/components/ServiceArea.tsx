        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="shadow-md border-0">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-xl">Cities We Serve</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="shadow-md border-0">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-xl">ZIP Codes Covered</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-2">
          ...
          <Card className="shadow-md border-0">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-xl">Our Local Promise</CardTitle>
            </CardHeader>
