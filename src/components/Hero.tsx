...
const Hero = () => {
  return (
    <section className="relative min-h-[80vh] flex items-center overflow-hidden">
      {/* Background Gradient - Navy to Bronze */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            <div className="mb-6">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold leading-tight mb-6 text-primary-foreground">
                Fast and Reliable
          ...
          <div className="lg:flex justify-end hidden">
            <div className="bg-background rounded-xl shadow-lg p-8 max-w-md w-full border border-primary/8">
